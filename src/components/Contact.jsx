            ...
            <div className='container mb-5'>
                ...
                <div className="row">
                    <div className="col-md-5 d-flex justify-content-center ">
                        <img src='/assets/contact-us.jpg' alt='Contact Us' style={{width: 400 , height:350}}/>
                    </div>
                    <div className="col-md-6">
                        <form>
                            ...
                            <div className="mb-3">
                                <label htmlFor="exampleForm" className="form-label">Comment</label>
                                <textarea className="form-control" id="exampleFormControl" rows="3"></textarea>
                            </div>
